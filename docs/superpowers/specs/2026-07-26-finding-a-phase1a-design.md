...
| T23 | `ConvenienceOverloadDefaultsAreTheRealHelpers` | **Eight clauses (a)–(h); see “T23 in full” below** — the row is too large to read inline. Covers the convenience overloads' default bindings, the real helpers' bodies, and everything production derives rather than receives | the default bindings do not exist |
