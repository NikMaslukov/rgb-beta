...
internal static class RgbNativeSelfCheck
{
    ...
    // internal, not private: T22 asserts against these directly, and §3's standing accessibility
...
**T17, T21 and T22 are regression guards** (each passes at introduction and exists to fail later; T21 and T22 additionally require the staged-native precondition): it passes on the commit that introduces it and exists to fail later
