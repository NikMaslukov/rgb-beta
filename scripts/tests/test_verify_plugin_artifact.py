...
class ArtifactFixture:
    def __init__(self, root: Path, strict_gate: bool = False):
        ...
        plain_files = {
            ...
            "BTCPayServer.Plugins.RGB.dll": b"plugin",
        ...
        self.write_json(
            "BTCPayServer.Plugins.RGB.deps.json",
...
class VerifyPluginArtifactTests(unittest.TestCase):
    ...
    def test_extra_native_assets_do_not_create_support_claims(self):
        ...
        deps_path = fixture.publish / "BTCPayServer.Plugins.RGB.deps.json"
        deps = json.loads(deps_path.read_text(encoding="utf-8"))
        deps["targets"]["net10.0"]["RgbLib/0.3.0-test"]["runtimeTargets"][win_core] = {
            "rid": "win-x64",
            "assetType": "native",
        }
        fixture.write_json("BTCPayServer.Plugins.RGB.deps.json", deps)
